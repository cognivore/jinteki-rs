...
pub fn boom() -> Card {
    card("BOOM!")
        ...
        .subtypes(&[Subtype::Double, Subtype::BlackOps])
        .cost(4)
        .trash_cost(1)
...
pub fn archangel() -> Card {
    card("Archangel")
        ...
        .ice(6)
        .faction("NBN")
        .subtypes(&[Subtype::CodeGate, Subtype::Tracer, Subtype::Ambush])
        .cost(4)
...
pub fn ip_block() -> Card {
    card("IP Block")
        ...
        .ice(4)
        .faction("NBN")
        .subtypes(&[Subtype::Barrier, Subtype::Tracer])
        .cost(2)
        ...
        .when(
            encountered(),
            [if_met(
                &[board_has(&[of_type(CardType::Program), with_subtype(Subtype::Ai)], 1)],
                [give_tags(1)],
            )],
        )
