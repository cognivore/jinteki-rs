...
- **Priority decks: 70/70 cards complete**, 0 printed sentences still
  unsayable (`cargo test -p jinteki-cards --test decks -- --nocapture`,
  ratcheted by `the_gap_list_is_measurable_and_honest`). Cards 51–70 are
...
- **Identity queue: 129/150** (`docs/vm/IDENTITY-QUEUE.md`, the list and the
  ...
  a pile. Runner Criminal 21/22, Shaper 19/21, Anarch 15/19, Neutral 3/3,
  Apex 1/1, Sunny 1/1, Adam 0/1; Corp Haas-Bioroid 17/19, Jinteki 17/21,
  NBN 17/19, Weyland 15/19, Neutral 3/4. **Every complete
  Criminal is enlisted** in `cr::ANDROMEDA_PILE`, so `priority_decks()` is 70
