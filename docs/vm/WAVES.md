...
- **DP-7a: 118/243** CR examples as example-named passing tests (48.6%).
  Unfrozen since FT-0 landed; the climb to 243/243 has resumed.
- **DP-7b: 448/1420** distinct rules cited (31.5%); traceability test fails
